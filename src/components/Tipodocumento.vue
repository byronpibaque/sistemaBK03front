        ...
        methods: {
            ...
            guardar(){
                ...
                if (this.editedIndex >-1){
                    //Código para editar
                    axios.put('tipodocumento/update',{'_id':this._id,'descripcion':this.descripcion})
                    ...
                    //Código para guardar
                    axios.post('tipodocumento/add',{'descripcion':this.descripcion})
                    .then(function(response){
                        me.limpiar();
                        me.close();
                        me.listar();
            ...
            activar(){
                let me=this;
                axios.put('tipodocumento/activate',{'_id':this.adId})
                    .then(function(response){
                        me.adModal=0;
                        me.adAccion=0;
                        me.adNombre='';
            ...
            desactivar(){
                let me=this;
                axios.put('tipodocumento/deactivate',{'_id':this.adId})
                    .then(function(response){
                        me.adModal=0;
                        me.adAccion=0;
                        me.adNombre='';
