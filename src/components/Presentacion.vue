    ...
    export default {
        ...
        methods: {
            listar(){
                ...
                axios.get('presentacion/list',configuracion).then(function (response){
            ...
            validar(){
                ...
                if(this.descripcion.length>255){
                    this.validaMensaje.push('La descripción de la presentacion no debe tener más de 255 caracteres.');
                }
            ...
            guardar(){
                ...
                if (this.editedIndex >-1){
                    //Código para editar
                    axios.put('presentacion/update',{'_id':this._id,'descripcion':this.descripcion})
                    ...
                    //Código para guardar
                    axios.post('presentacion/add',{'descripcion':this.descripcion})
                    .then(function(response){
                        me.limpiar();
                        me.close();
                        me.listar();
            ...
            activar(){
                let me=this;
                axios.put('presentacion/activate',{'_id':this.adId})
                    .then(function(response){
                        me.adModal=0;
                        me.adAccion=0;
                        me.adNombre='';
            ...
            desactivar(){
                let me=this;
                axios.put('presentacion/deactivate',{'_id':this.adId})
                    .then(function(response){
                        me.adModal=0;
                        me.adAccion=0;
                         me.adNombre='';
