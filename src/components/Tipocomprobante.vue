    ...
    export default {
        ...
        methods: {
            listar(){
                ...
                axios.get('tipocomprobante/list',configuracion).then(function (response){
                    me.tipocom=response.data;
            ...
            guardar(){
                ...
                if (this.editedIndex >-1){
                    //Código para editar
                    axios.put('tipocomprobante/update',{'_id':this._id,'descripcion':this.descripcion})
                    ...
                    //Código para guardar
                    axios.post('tipocomprobante/add',{'descripcion':this.descripcion})
                    .then(function(response){
                        me.limpiar();
                        me.close();
                        me.listar();
            ...
            activar(){
                let me=this;
                axios.put('tipocomprobante/activate',{'_id':this.adId})
                    .then(function(response){
                        me.adModal=0;
                        me.adAccion=0;
                        me.adNombre='';
            ...
            desactivar(){
                let me=this;
                axios.put('tipocomprobante/deactivate',{'_id':this.adId})
                    .then(function(response){
                        me.adModal=0;
                        me.adAccion=0;
                        me.adNombre='';
