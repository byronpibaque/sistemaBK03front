    ...
    <v-flex>
      ...
      >
        <template v-slot:items="props">
          <td class="justify-center layout px-0">
           <template v-if="$store.state.usuario.codigoFarmacia == undefined|| $store.state.usuario.rol=='5ee381d7005ebf28f0e5260b'">
      ...
      >
        <template v-slot:items="props">
          ...
          <td v-if="props.item._id.codigoPersona">{{ props.item._id.codigoPersona.nombres }}</td>
          <td v-else>undefined</td>
...
export default {
  data() {
    return {
      ...
      chckFarmacia:false,
      headerstotalizado:[
         { text: "Cliente", value: "_id.codigoPersona.nombres", sorteable: true },
    ...
    crearPDF() {
      ...
      doc.autoTable(columns, rows, {
        ...
        addPageContent: function(data) {
          ...
          doc.text("Reporte de créditos del mes de "+month.toUpperCase(), 60, 40);
